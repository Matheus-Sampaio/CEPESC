    <div id="main">
        <div class="container">
            <h1 id="Brincando de Ioiô">Artigos do CEPESC</h1>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-10 col-xs-12">
                <div class="artigo">
                    ...
                    <p>Hoje é o meu 118° dia de estadia aqui no hotel, digo, Hospital das Clínicas em Salvador-Ba e, ouvir o meu silêncio tem sido um exercício diário na construção, desconstrução e edificação literal do meu “pensar”, o que me traz lógica para refletir sobre as próprias verdades, tropeçando na maioria das vezes, subindo e descendo, tentando alcançar o degrau do imaginário construído pelos meus achismos e experiências pessoais.</p>
                    <p>Quem na vida não brincou de ioiô? Desce-sobe...Sempre desce primeiro, depois, talvez suba. Para ele subir direito é preciso darmos um puxão, porém, se largarmos o ioiô ele se desenrolará, e a depender do impulso, poderá subir novamente, ou não. Ao encerrar a brincadeira, o melhor é fazê-lo subir por inteiro e toma-lo na mão. Se ele ficar em baixo sobrará aquele fio solto inconveniente, que poderá embaraçar. Assim tem sido a minha vida nestes últimos meses</p>
                    <p>Já me “hospedei” aqui, neste período, em seis apartamentos, em andares distintos e, entre subidas e descidas, tenho me visitado com o encantamento do encontro e/ou reencontro comigo mesmo. Algo esplêndido! Sensação de estar nu diante de si mesmo.</p>
                    <p>E como diz o versículo 7 da nossa leitura: “Ainda que eu passe por angústias” (descer)... “Estendes a tua mão direita e me livras” (Subir). Sendo esta a dinâmica da minha vida.</p>
                    <p>É verdade que conseguimos subir de novo um pouco mas de desce-sobe em desce-sobe, quem nos segura mesmo lá em cima é DEUS.</p>
                    <p id="Sobre Deuses e Rezas">Assim Seja!</p>
                    <p class="direita">Salvador, 17 de Novembro de 2011</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-12 col-xs-12">
                <div class="artigo">
                     ...
                     <p>Há muito tempo atrás, em uma terra bem distante da nossa, viveu um homem muito simples, que tinha o costume da falar com Deus. Ele morava numa pequena vila, de nome estranho, no interior do seu país.</p>
                     <p>Apesar de humilde e morar bem longe da cidade, ele pensava muito no seu país que estava dividido e tinha muitos problemas: Havia muita injustiça e maldade, contra os pobres, as mulheres e as crianças; havia alguns homens ricos e milhares na miséria; os governantes oprimiam o povo e se corrompiam; os líderes religiosos eram muito hipócritas: em nome de Deus exploravam o povo e ainda diziam que Deus estava com eles.</p>
                     <p>Depois de algum tempo, um problema ainda mais grave surgiu. Um povo guerreiro, forte e poderoso ameaçou invadir a sua terra e escravizar a sua gente. O homem que falava com Deus considerou a situação muito difícil: Infidelidade, injustiça, corrupção e hipocrisia religiosa dentro do reino, e ameaça de domínio e escravidão de fora.</p>
                     <p>O homem simples e do interior até chorou, mas depois achou que não devia ficar parado e nem calado. Ele falou com o seu Deus, deixou o lugar onde morava por algum tempo e foi para a cidade grande. Lá, começou a denunciar os problemas, a anunciar o castigo e a futura providência de Deus. </p>
                     <p>O homem simples e da roça, que falava com Deus, discursava nas ruas, nas praças e no lugar sagrado de oração do seu povo. Ele condenava as injustiças, a maldade dos governantes, a hipocrisia dos religiosos e a perversidade dos ricos e poderosos.</p>
                     <p>E disse coisas muito tristes: Que o poderoso exército inimigo ia invadir e dominar a sua terra, muita gente iria ser levada para o cativeiro e longe do seu país iria ficar por muitos anos. Vários deles morreriam no exílio. E disse também que o lugar sagrado de oração ia ser destruído pelos invasores.</p>
